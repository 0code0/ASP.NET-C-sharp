<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="AskQuestion, App_Web_q3lbdyzj" %>
                                ...
                                <div id="QuestionDetail">
                                   ...
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter the Description Of Question" 
                                    ControlToValidate="DescriptionV">*</asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Button ID="SubmitAns" runat="server" Text="Post" 
                                                    onclick="SubmitAns_Click" />
