<%@ page title="" validaterequest="false" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="User_AnswerById, App_Web_btwqd1v2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div id="Title">
                <div id="Title_Left"><h3>Recent Question</h3>
                    ...
                    <p><%# Eval("Title") %>
                      <i><a  href="#" id="Title_Left_Click1">Views<%# Eval("NoOfViews") %></a></i><i><a  href="#" id=""></a></i></p>
                </div>
    ...
    <div class="Hide">            
               ...
               <p><%# Eval("Description") %>
                        ...
                        <samp><%# Eval("UserName") %></samp><samp><%# Eval("CreatedOn") %></samp>                    
                </div>
                </ItemTemplate>
                    </asp:FormView>
        ...
        <div id="Answer_Container">
                ...
                <p><%# Eval("Ans") %>
                    ...
                    <samp><%# Eval("UserName") %><%# Eval("CreatedOn") %></samp>
                     <span id="Vote"><a href="#">Vote: <%#Eval("Votes") %></a></span>
...
<div id="VoteStyle">
    ...
    <asp:Button ID="Button2" class="Click" runat="server" onclick="Button2_Click" Text="Button" />
