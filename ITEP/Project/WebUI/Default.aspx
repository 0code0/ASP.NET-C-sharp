...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="templatemo_main_leftcol">
        ...
        <div class="templatemo_leftcol_subcol">
            ...
            <div class="regular_section" style="margin-top:-30px"><!-- Replace-->
                <h2>
        ...
        <div class="tab_section">
            ...
            <ul id="countrytabs" class="shadetabs">
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetTopSix"
                    TypeName="BusinessLogic.NewsCategoryBL" 
                ...
                <li>
                    <asp:HyperLink ID="HyperLink2" NavigateUrl = "~/User/News.aspx" runat="server">More</asp:HyperLink>
                </li>
            </ul>
                            ...
                            <div class="newslist">
                                ...
                                <ul>
                                    ...
                                    <asp:Repeater ID="Repeater4" runat="server" DataSourceID="ObjectDataSource4">
                                        <ItemTemplate>
                                            <li>
                                                <asp:HyperLink Width="530" ID="hyp4" NavigateUrl='<%#"~/User/News.aspx?Id="+Eval("Id") %>' runat="server"><%# Eval("HeadLines") %></asp:HyperLink></li>
