<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ManageTopics.aspx.cs" Inherits="Admin_ManageTopics" %>
            ...
            <asp:TemplateField HeaderText = "Select Branch">
                ...
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList8" runat="server" 
                        ...
                        AutoPostBack="True" SelectedValue='<%# Bind("BranchId") %>'>
                    </asp:DropDownList>
