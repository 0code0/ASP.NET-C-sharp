<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ManageNews.aspx.cs" Inherits="Admin_ManageNews" %>
            ...
            <asp:TemplateField HeaderText="Upload Type">
                ...
                <InsertItemTemplate>
                    ...
                    <asp:DropDownList ID="DropDownList4" runat="server" 
                        ...
                        AutoPostBack="True" ondatabound="DropDownList4_DataBound" 
                        SelectedValue='<%# Bind("UploadTypeId") %>'>
                    </asp:DropDownList>
                </InsertItemTemplate>
                <ItemTemplate>
              ...
              <asp:BoundField DataField="HeadLines"  HeaderText="HeadLines" 
                ControlStyle-Height = "50px" ControlStyle-Width = "600px"
                SortExpression="HeadLines" >
...
<ControlStyle Height="30px" Width="300px"></ControlStyle>
            ...
            <asp:BoundField DataField="TextArea" ControlStyle-Width="700px" 
                ControlStyle-Height="60px"  HeaderText="TextArea" 
                SortExpression="TextArea" >
